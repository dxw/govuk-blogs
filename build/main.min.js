 ...
 */
(function(a){if(typeof define==="function"&&define.amd){define(["jquery"],a)}else if(typeof module==="object"&&module.exports){a(require("jquery"))}else{a(jQuery)}})(function(a){var b=false;var c=Object.prototype.toString.call(window.operamini)==="[object OperaMini]";var d="placeholder"in document.createElement("input")&&!c&&!b;var e="placeholder"in document.createElement("textarea")&&!c&&!b;var f=a.valHooks;var g=a.propHooks;var h;var i;var j={};if(d&&e){i=a.fn.placeholder=function(){return this};i.input=true;i.textarea=true}else{i=a.fn.placeholder=function(c){var e={customClass:"placeholder"};j=a.extend({},e,c);return this.filter((d?"textarea":":input")+"["+(b?"placeholder-x":"placeholder")+"]").not("."+j.customClass).not(":radio, :checkbox, [type=hidden]").bind({"focus.placeholder":l,"blur.placeholder":m}).data("placeholder-enabled",true).trigger("blur.placeholder")};i.input=d;i.textarea=e;h={get:function(b){var c=a(b);var d=c.data("placeholder-password");if(d){return d[0].value}return c.data("placeholder-enabled")&&c.hasClass(j.customClass)?"":b.value},set:function(b,c){var d=a(b);var e;var f;if(c!==""){e=d.data("placeholder-textinput");f=d.data("placeholder-password");if(e){l.call(e[0],true,c)||(b.value=c);e[0].value=c}else if(f){l.call(b,true,c)||(f[0].value=c);b.value=c}}if(!d.data("placeholder-enabled")){b.value=c;return d}if(c===""){b.value=c;if(b!=n()){m.call(b)}}else{if(d.hasClass(j.customClass)){l.call(b)}b.value=c}return d}};if(!d){f.input=h;g.value=h}if(!e){f.textarea=h;g.value=h}a(function(){a(document).delegate("form","submit.placeholder",function(){var b=a("."+j.customClass,this).each(function(){l.call(this,true,"")});setTimeout(function(){b.each(m)},10)})});a(window).bind("beforeunload.placeholder",function(){var b=true;try{if(document.activeElement.toString()==="javascript:void(0)"){b=false}}catch(a){}if(b){a("."+j.customClass).each(function(){this.value=""})}})}function k(b){var c={};var d=/^jQuery\d+$/;a.each(b.attributes,function(a,b){if(b.specified&&!d.test(b.name)){c[b.name]=b.value}});return c}function l(c,d){var e=this;var f=a(this);if(e.value===f.attr(b?"placeholder-x":"placeholder")&&f.hasClass(j.customClass)){e.value="";f.removeClass(j.customClass);if(f.data("placeholder-password")){f=f.hide().nextAll('input[type="password"]:first').show().attr("id",f.removeAttr("id").data("placeholder-id"));if(c===true){f[0].value=d;return d}f.focus()}else{e==n()&&e.select()}}}function m(c){var d;var e=this;var f=a(this);var g=e.id;if(c&&c.type==="blur"&&f.hasClass(j.customClass)){return}if(e.value===""){if(e.type==="password"){if(!f.data("placeholder-textinput")){try{d=f.clone().prop({type:"text"})}catch(b){d=a("<input>").attr(a.extend(k(this),{type:"text"}))}d.removeAttr("name").data({"placeholder-enabled":true,"placeholder-password":f,"placeholder-id":g}).bind("focus.placeholder",l);f.data({"placeholder-textinput":d,"placeholder-id":g}).before(d)}e.value="";f=f.removeAttr("id").hide().prevAll('input[type="text"]:first').attr("id",f.data("placeholder-id")).show()}else{var h=f.data("placeholder-password");if(h){h[0].value="";f.attr("id",f.data("placeholder-id")).show().nextAll('input[type="password"]:last').hide().removeAttr("id")}}f.addClass(j.customClass);f[0].value=f.attr(b?"placeholder-x":"placeholder")}else{f.removeClass(j.customClass)}}function n(){try{return document.activeElement}catch(a){}}});/*!
 * Bowser - a browser detector
 * https://github.com/ded/bowser
 * MIT License | (c) Dustin Diaz 2015
 */
!function(a,b,c){if(typeof module!="undefined"&&module.exports)module.exports=c();else if(typeof define=="function"&&define.amd)define(b,c);else a[b]=c()}(this,"bowser",function(){var a=true;function b(b){function c(a){var c=b.match(a);return c&&c.length>1&&c[1]||""}function d(a){var c=b.match(a);return c&&c.length>1&&c[2]||""}var e=c(/(ipod|iphone|ipad)/i).toLowerCase(),f=/like android/i.test(b),g=!f&&/android/i.test(b),h=/nexus\s*[0-6]\s*/i.test(b),i=!h&&/nexus\s*[0-9]+/i.test(b),j=/CrOS/.test(b),k=/silk/i.test(b),l=/sailfish/i.test(b),m=/tizen/i.test(b),n=/(web|hpw)os/i.test(b),o=/windows phone/i.test(b),p=/SamsungBrowser/i.test(b),q=!o&&/windows/i.test(b),r=!e&&!k&&/macintosh/i.test(b),s=!g&&!l&&!m&&!n&&/linux/i.test(b),t=d(/edg([ea]|ios)\/(\d+(\.\d+)?)/i),u=c(/version\/(\d+(\.\d+)?)/i),v=/tablet/i.test(b)&&!/tablet pc/i.test(b),w=!v&&/[^-]mobi/i.test(b),x=/xbox/i.test(b),y;if(/opera/i.test(b)){y={name:"Opera",opera:a,version:u||c(/(?:opera|opr|opios)[\s\/](\d+(\.\d+)?)/i)}}else if(/opr\/|opios/i.test(b)){y={name:"Opera",opera:a,version:c(/(?:opr|opios)[\s\/](\d+(\.\d+)?)/i)||u}}else if(/SamsungBrowser/i.test(b)){y={name:"Samsung Internet for Android",samsungBrowser:a,version:u||c(/(?:SamsungBrowser)[\s\/](\d+(\.\d+)?)/i)}}else if(/coast/i.test(b)){y={name:"Opera Coast",coast:a,version:u||c(/(?:coast)[\s\/](\d+(\.\d+)?)/i)}}else if(/yabrowser/i.test(b)){y={name:"Yandex Browser",yandexbrowser:a,version:u||c(/(?:yabrowser)[\s\/](\d+(\.\d+)?)/i)}}else if(/ucbrowser/i.test(b)){y={name:"UC Browser",ucbrowser:a,version:c(/(?:ucbrowser)[\s\/](\d+(?:\.\d+)+)/i)}}else if(/mxios/i.test(b)){y={name:"Maxthon",maxthon:a,version:c(/(?:mxios)[\s\/](\d+(?:\.\d+)+)/i)}}else if(/epiphany/i.test(b)){y={name:"Epiphany",epiphany:a,version:c(/(?:epiphany)[\s\/](\d+(?:\.\d+)+)/i)}}else if(/puffin/i.test(b)){y={name:"Puffin",puffin:a,version:c(/(?:puffin)[\s\/](\d+(?:\.\d+)?)/i)}}else if(/sleipnir/i.test(b)){y={name:"Sleipnir",sleipnir:a,version:c(/(?:sleipnir)[\s\/](\d+(?:\.\d+)+)/i)}}else if(/k-meleon/i.test(b)){y={name:"K-Meleon",kMeleon:a,version:c(/(?:k-meleon)[\s\/](\d+(?:\.\d+)+)/i)}}else if(o){y={name:"Windows Phone",osname:"Windows Phone",windowsphone:a};if(t){y.msedge=a;y.version=t}else{y.msie=a;y.version=c(/iemobile\/(\d+(\.\d+)?)/i)}}else if(/msie|trident/i.test(b)){y={name:"Internet Explorer",msie:a,version:c(/(?:msie |rv:)(\d+(\.\d+)?)/i)}}else if(j){y={name:"Chrome",osname:"Chrome OS",chromeos:a,chromeBook:a,chrome:a,version:c(/(?:chrome|crios|crmo)\/(\d+(\.\d+)?)/i)}}else if(/edg([ea]|ios)/i.test(b)){y={name:"Microsoft Edge",msedge:a,version:t}}else if(/vivaldi/i.test(b)){y={name:"Vivaldi",vivaldi:a,version:c(/vivaldi\/(\d+(\.\d+)?)/i)||u}}else if(l){y={name:"Sailfish",osname:"Sailfish OS",sailfish:a,version:c(/sailfish\s?browser\/(\d+(\.\d+)?)/i)}}else if(/seamonkey\//i.test(b)){y={name:"SeaMonkey",seamonkey:a,version:c(/seamonkey\/(\d+(\.\d+)?)/i)}}else if(/firefox|iceweasel|fxios/i.test(b)){y={name:"Firefox",firefox:a,version:c(/(?:firefox|iceweasel|fxios)[ \/](\d+(\.\d+)?)/i)};if(/\((mobile|tablet);[^\)]*rv:[\d\.]+\)/i.test(b)){y.firefoxos=a;y.osname="Firefox OS"}}else if(k){y={name:"Amazon Silk",silk:a,version:c(/silk\/(\d+(\.\d+)?)/i)}}else if(/phantom/i.test(b)){y={name:"PhantomJS",phantom:a,version:c(/phantomjs\/(\d+(\.\d+)?)/i)}}else if(/slimerjs/i.test(b)){y={name:"SlimerJS",slimer:a,version:c(/slimerjs\/(\d+(\.\d+)?)/i)}}else if(/blackberry|\bbb\d+/i.test(b)||/rim\stablet/i.test(b)){y={name:"BlackBerry",osname:"BlackBerry OS",blackberry:a,version:u||c(/blackberry[\d]+\/(\d+(\.\d+)?)/i)}}else if(n){y={name:"WebOS",osname:"WebOS",webos:a,version:u||c(/w(?:eb)?osbrowser\/(\d+(\.\d+)?)/i)};/touchpad\//i.test(b)&&(y.touchpad=a)}else if(/bada/i.test(b)){y={name:"Bada",osname:"Bada",bada:a,version:c(/dolfin\/(\d+(\.\d+)?)/i)}}else if(m){y={name:"Tizen",osname:"Tizen",tizen:a,version:c(/(?:tizen\s?)?browser\/(\d+(\.\d+)?)/i)||u}}else if(/qupzilla/i.test(b)){y={name:"QupZilla",qupzilla:a,version:c(/(?:qupzilla)[\s\/](\d+(?:\.\d+)+)/i)||u}}else if(/chromium/i.test(b)){y={name:"Chromium",chromium:a,version:c(/(?:chromium)[\s\/](\d+(?:\.\d+)?)/i)||u}}else if(/chrome|crios|crmo/i.test(b)){y={name:"Chrome",chrome:a,version:c(/(?:chrome|crios|crmo)\/(\d+(\.\d+)?)/i)}}else if(g){y={name:"Android",version:u}}else if(/safari|applewebkit/i.test(b)){y={name:"Safari",safari:a};if(u){y.version=u}}else if(e){y={name:e=="iphone"?"iPhone":e=="ipad"?"iPad":"iPod"};if(u){y.version=u}}else if(/googlebot/i.test(b)){y={name:"Googlebot",googlebot:a,version:c(/googlebot\/(\d+(\.\d+))/i)||u}}else{y={name:c(/^(.*)\/(.*) /),version:d(/^(.*)\/(.*) /)}}if(!y.msedge&&/(apple)?webkit/i.test(b)){if(/(apple)?webkit\/537\.36/i.test(b)){y.name=y.name||"Blink";y.blink=a}else{y.name=y.name||"Webkit";y.webkit=a}if(!y.version&&u){y.version=u}}else if(!y.opera&&/gecko\//i.test(b)){y.name=y.name||"Gecko";y.gecko=a;y.version=y.version||c(/gecko\/(\d+(\.\d+)?)/i)}if(!y.windowsphone&&(g||y.silk)){y.android=a;y.osname="Android"}else if(!y.windowsphone&&e){y[e]=a;y.ios=a;y.osname="iOS"}else if(r){y.mac=a;y.osname="macOS"}else if(x){y.xbox=a;y.osname="Xbox"}else if(q){y.windows=a;y.osname="Windows"}else if(s){y.linux=a;y.osname="Linux"}function z(a){switch(a){case"NT":return"NT";case"XP":return"XP";case"NT 5.0":return"2000";case"NT 5.1":return"XP";case"NT 5.2":return"2003";case"NT 6.0":return"Vista";case"NT 6.1":return"7";case"NT 6.2":return"8";case"NT 6.3":return"8.1";case"NT 10.0":return"10";default:return undefined}}var A="";if(y.windows){A=z(c(/Windows ((NT|XP)( \d\d?.\d)?)/i))}else if(y.windowsphone){A=c(/windows phone (?:os)?\s?(\d+(\.\d+)*)/i)}else if(y.mac){A=c(/Mac OS X (\d+([_\.\s]\d+)*)/i);A=A.replace(/[_\s]/g,".")}else if(e){A=c(/os (\d+([_\s]\d+)*) like mac os x/i);A=A.replace(/[_\s]/g,".")}else if(g){A=c(/android[ \/-](\d+(\.\d+)*)/i)}else if(y.webos){A=c(/(?:web|hpw)os\/(\d+(\.\d+)*)/i)}else if(y.blackberry){A=c(/rim\stablet\sos\s(\d+(\.\d+)*)/i)}else if(y.bada){A=c(/bada\/(\d+(\.\d+)*)/i)}else if(y.tizen){A=c(/tizen[\/\s](\d+(\.\d+)*)/i)}if(A){y.osversion=A}var B=!y.windows&&A.split(".")[0];if(v||i||e=="ipad"||g&&(B==3||B>=4&&!w)||y.silk){y.tablet=a}else if(w||e=="iphone"||e=="ipod"||g||h||y.blackberry||y.webos||y.bada){y.mobile=a}if(y.msedge||y.msie&&y.version>=10||y.yandexbrowser&&y.version>=15||y.vivaldi&&y.version>=1||y.chrome&&y.version>=20||y.samsungBrowser&&y.version>=4||y.firefox&&y.version>=20||y.safari&&y.version>=6||y.opera&&y.version>=10||y.ios&&y.osversion&&y.osversion.split(".")[0]>=6||y.blackberry&&y.version>=10.1||y.chromium&&y.version>=20){y.a=a}else if(y.msie&&y.version<10||y.chrome&&y.version<20||y.firefox&&y.version<20||y.safari&&y.version<6||y.opera&&y.version<10||y.ios&&y.osversion&&y.osversion.split(".")[0]<6||y.chromium&&y.version<20){y.c=a}else y.x=a;return y}var c=b(typeof navigator!=="undefined"?navigator.userAgent||"":"");c.test=function(a){for(var b=0;b<a.length;++b){var d=a[b];if(typeof d==="string"){if(d in c){return true}}}return false};function d(a){return a.split(".").length}function e(a,b){var c=[],d;if(Array.prototype.map){return Array.prototype.map.call(a,b)}for(d=0;d<a.length;d++){c.push(b(a[d]))}return c}function f(a){var b=Math.max(d(a[0]),d(a[1]));var c=e(a,function(a){var c=b-d(a);a=a+new Array(c+1).join(".0");return e(a.split("."),function(a){return new Array(20-a.length).join("0")+a}).reverse()});while(--b>=0){if(c[0][b]>c[1][b]){return 1}else if(c[0][b]===c[1][b]){if(b===0){return 0}}else{return-1}}}function g(a,d,e){var g=c;if(typeof d==="string"){e=d;d=void 0}if(d===void 0){d=false}if(e){g=b(e)}var h=""+g.version;for(var i in a){if(a.hasOwnProperty(i)){if(g[i]){if(typeof a[i]!=="string"){throw new Error("Browser version in the minVersion map should be a string: "+i+": "+String(a))}return f([h,a[i]])<0}}}return d}function h(a,b,c){return!g(a,b,c)}c.isUnsupportedBrowser=g;c.compareVersions=f;c.check=h;c._detect=b;c.detect=b;return c});(function(a){var b=function(){try{return!!Symbol.iterator}catch(a){return false}};var c=b();var d=function(a){var b={next:function(){var b=a.shift();return{done:b===void 0,value:b}}};if(c){b[Symbol.iterator]=function(){return b}}return b};var e=function(){var b=function(a){Object.defineProperty(this,"_entries",{value:{}});if(typeof a==="string"){if(a!==""){a=a.replace(/^\?/,"");var c=a.split("&");var d;for(var e=0;e<c.length;e++){d=c[e].split("=");this.append(decodeURIComponent(d[0]),d.length>1?decodeURIComponent(d[1]):"")}}}else if(a instanceof b){var f=this;a.forEach(function(a,b){f.append(a,b)})}};var e=b.prototype;e.append=function(a,b){if(a in this._entries){this._entries[a].push(b.toString())}else{this._entries[a]=[b.toString()]}};e.delete=function(a){delete this._entries[a]};e.get=function(a){return a in this._entries?this._entries[a][0]:null};e.getAll=function(a){return a in this._entries?this._entries[a].slice(0):[]};e.has=function(a){return a in this._entries};e.set=function(a,b){this._entries[a]=[b.toString()]};e.forEach=function(a,b){var c;for(var d in this._entries){if(this._entries.hasOwnProperty(d)){c=this._entries[d];for(var e=0;e<c.length;e++){a.call(b,c[e],d,this)}}}};e.keys=function(){var a=[];this.forEach(function(b,c){a.push(c)});return d(a)};e.values=function(){var a=[];this.forEach(function(b){a.push(b)});return d(a)};e.entries=function(){var a=[];this.forEach(function(b,c){a.push([c,b])});return d(a)};if(c){e[Symbol.iterator]=e.entries}e.toString=function(){var a="";this.forEach(function(b,c){if(a.length>0)a+="&";a+=encodeURIComponent(c)+"="+encodeURIComponent(b)});return a};a.URLSearchParams=b};if(!("URLSearchParams"in a)||new URLSearchParams("?a=1").toString()!=="a=1"){e()}})(typeof global!=="undefined"?global:typeof window!=="undefined"?window:typeof self!=="undefined"?self:this);(function(a){var b=function(){try{var a=new URL("b","http://a");a.pathname="c%20d";return a.href==="http://a/c%20d"&&a.searchParams}catch(a){return false}};var c=function(){var b=a.URL;var c=function(a,b){if(typeof a!=="string")a=String(a);var c=document.implementation.createHTMLDocument("");window.doc=c;if(b){var d=c.createElement("base");d.href=b;c.head.appendChild(d)}var e=c.createElement("a");e.href=a;c.body.appendChild(e);e.href=e.href;if(e.protocol===":"||!/:/.test(e.href)){throw new TypeError("Invalid URL")}Object.defineProperty(this,"_anchorElement",{value:e})};var d=c.prototype;var e=function(a){Object.defineProperty(d,a,{get:function(){return this._anchorElement[a]},set:function(b){this._anchorElement[a]=b},enumerable:true})};["hash","host","hostname","port","protocol","search"].forEach(function(a){e(a)});Object.defineProperties(d,{toString:{get:function(){var a=this;return function(){return a.href}}},href:{get:function(){return this._anchorElement.href.replace(/\?$/,"")},set:function(a){this._anchorElement.href=a},enumerable:true},pathname:{get:function(){return this._anchorElement.pathname.replace(/(^\/?)/,"/")},set:function(a){this._anchorElement.pathname=a},enumerable:true},origin:{get:function(){return this._anchorElement.protocol+"//"+this._anchorElement.hostname+(this._anchorElement.port?":"+this._anchorElement.port:"")},enumerable:true},password:{get:function(){return""},set:function(a){},enumerable:true},username:{get:function(){return""},set:function(a){},enumerable:true},searchParams:{get:function(){var a=new URLSearchParams(this.search);var b=this;["append","delete","set"].forEach(function(c){var d=a[c];a[c]=function(){d.apply(a,arguments);b.search=a.toString()}});return a},enumerable:true}});c.createObjectURL=function(a){return b.createObjectURL.apply(b,arguments)};c.revokeObjectURL=function(a){return b.revokeObjectURL.apply(b,arguments)};a.URL=c};if(!b()){c()}if(a.location!==void 0&&!("origin"in a.location)){var d=function(){return a.location.protocol+"//"+a.location.hostname+(a.location.port?":"+a.location.port:"")};try{Object.defineProperty(a.location,"origin",{get:d,enumerable:true})}catch(b){setInterval(function(){a.location.origin=d()},100)}}})(typeof global!=="undefined"?global:typeof window!=="undefined"?window:typeof self!=="undefined"?self:this);jQuery(function(a){"use strict";a(".js-categories-dropdown").change(function(a){var b=parseInt(this.value,10);if(b===0){location.href="/"}else{location.href="/?cat="+b}});var b=a("#comment"),c=a(".js-comment-extra"),d=b.height();c.hide();b.height(d/4);b.focus(function(){b.animate({height:d});c.slideDown()});a("input, textarea").placeholder();var e=a(window).width();if(e<768){a(".widget_categories ul").each(function(){var b=a(this),c=a(document.createElement("select")).insertBefore(a(this).hide()).addClass("category-list").change(function(){window.location.href=a(this).val()});a('<option selected="selected">Select Category</option>').appendTo(c);a(">li a",this).each(function(){var b=a(document.createElement("option")).appendTo(c).val(this.href).html(a(this).html())});b.remove()})}a(function(){a("input.search-query").data("holder",a("input.search-query").attr("placeholder"));a("input.search-query").focusin(function(){a(this).attr("placeholder","")});a("input.search-query").focusout(function(){a(this).attr("placeholder",a(this).data("holder"))})});a(window).resize(function(){if(a(window).width()<768){a(".widget_categories ul").not("hidden-mobile").each(function(){var b=a(this),c=a(document.createElement("select")).insertBefore(a(this).hide()).addClass("category-list").change(function(){window.location.href=a(this).val()});a('<option selected="selected">Select Category</option>').appendTo(c);a(">li a",this).each(function(){var b=a(document.createElement("option")).appendTo(c).val(this.href).html(a(this).html())});b.remove()})}else{a("select.category-list").parent().append('<ul class="categories"></ul>');a("select.category-list option:first-child").remove();a("select.category-list option").each(function(){a("ul.categories").append('<li class="cat-item"><a href="'+a(this).val()+'">'+a(this).text()+"</a></li>")});a("select.category-list").remove()}});a(".embedly-embed").css({position:"relative"}).parent().css({"padding-top":"0","padding-bottom":"0",height:"auto"});a(document).ready(function(){var b=GOVUK.cookie("no-more-survey");if(b!="true"){a("#user-satisfaction-survey").show()}});a("#survey-no-thanks").click(function(){GOVUK.cookie("no-more-survey","true",{days:365});a("#user-satisfaction-survey").hide()});a("#take-survey").click(function(){GOVUK.cookie("no-more-survey","true",{days:365})});if(bowser.msie){var f=a("html");for(var g=0;g<=15;g++){if(bowser.version<=g){f.addClass("lte-ie"+g)}if(bowser.version<g){f.addClass("lt-ie"+g)}}}a("a").click(function(b){var c=a(b.currentTarget).attr("href");var d=new URL(c,document.location.href);var e=d.protocol==="https:";var f=d.hostname==="blog.gov.uk"||d.hostname.endsWith(".blog.gov.uk");if(e&&f){return}b.preventDefault();setTimeout(h,1e3);var g=false;function h(){if(!g){g=true;document.location=d.href}}ga("send","event","outbound","click",d.href,{transport:"beacon",hitCallback:function(){h()}})})});function scrollToId(a){var b=$(a);$("html,body").animate({scrollTop:b.offset().top},"slow")}function inputEmpty(a){if(a.hasClass("required")&&a.val()==""){return true}return false}function validEmail(a){var b=/^[a-z0-9!#$%&'*+\/=?^_`{|}~-]+(?:\.[a-z0-9!#$%&'*+\/=?^_`{|}~-]+)*@(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\.)+[a-z0-9](?:[a-z0-9-]*[a-z0-9])?/i;return b.test(a)}function invalidEmailInput(a){if(a.hasClass("required")&&!validEmail(a.val())){return true}return false}function addErrorPanel(a){$("#comment-validation").remove();var b='<div id="comment-validation" class="error-summary alert" role="alert">';b+="<h3>Please complete the required fields</h3>";a.forEach(function(a){b+="<p>"+a+"</p>"});b+="</div>";$("#respond header").after(b)}function addErrorMarker(a,b){a.parent("div.form-group").addClass("error");a.siblings("label").append("<span class='error'>"+b+"</span>")}function removeErrorMarker(a){a.siblings("label").find("span.error").remove();a.parent("div.form-group").removeClass("error")}jQuery(function(a){"use strict";a("#commentform input#submit").click(function(){var b=[];var c=a("#commentform #comment");var d=a("#commentform #author");var e=a("#commentform #email");removeErrorMarker(c);removeErrorMarker(d);removeErrorMarker(e);if(inputEmpty(c)){var f="Please enter comment text";b.push("<a href='#comment_field'>"+f+"</a>");addErrorMarker(c,f)}if(inputEmpty(d)){var f="Please enter a name";b.push("<a href='#name_field'>"+f+"</a>");addErrorMarker(d,f)}if(invalidEmailInput(e)){var f="Please enter a valid email address";b.push("<a href='#email_field'>"+f+"</a>");addErrorMarker(e,f)}if(b.length>0){addErrorPanel(b);scrollToId("#comment-validation");return false}})});
