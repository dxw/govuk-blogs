...
}catch(g){a=c("<input>").attr(c.extend(j(this),{type:"text"}))}a.removeAttr("name").data({"placeholder-password":true,"placeholder-id":f}).bind("focus.placeholder",k);d.data({"placeholder-textinput":a,"placeholder-id":f}).before(a)}d=d.removeAttr("id").hide().prev().attr("id",f).show()}d.addClass("placeholder");d[0].value=d.attr("placeholder")}else{d.removeClass("placeholder")}}}(this,document,jQuery);"use strict";jQuery(function(a){a(".js-categories-dropdown").change(function(a){var b=parseInt(this.value);if(b===0){location.href="/"}else{location.href="/?cat="+b}});var b=a("#comment"),c=a(".js-comment-extra"),d=b.height();c.hide();b.height(d/4);b.focus(function(){b.animate({height:d});c.slideDown()});if(cookie.get("gds_seen_cookie_message")===undefined){cookie.set("gds_seen_cookie_message","true");a(".js-cookies-banner").each(function(){a(this).html('<div class="cookie-message full-width">'+'  <div class="container">'+'    <div class="row">'+'      <div class="span12">'+"        <p>"+'          GOV.UK blogs use cookies to make the site simpler. <a href="https://blog.gov.uk/cookies/">Find out more about cookies</a>'+"        </p>"+"      </div>"+"    </div>"+"  </div>"+"</div>")})}a("input, textarea").placeholder()});